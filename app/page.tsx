...
import { 
  ...
  Sparkle, Calculator, ArrowUpRight, Heart, Zap, Leaf, Shield
} from 'lucide-react';
...
export default function Time2CoinMainApp() {
  ...
  const [activeTab, setActiveTab] = useState<'dashboard' | 'services' | 'holding' | 'food' | 'mesh' | 'review' | 'post'>('dashboard');
        ...
        <div className="max-w-7xl mx-auto px-4 py-3 flex items-center justify-between gap-2 w-full">
          ...
          <div className="hidden lg:flex items-center gap-1.5 shrink-0">
            ...
            <a href="/corporate" className="px-3 py-1.5 text-slate-300 hover:text-blue-400 rounded-lg text-xs font-semibold transition flex items-center gap-1">
              <Building2 className="w-3.5 h-3.5 text-blue-400" /> Corporate CSR
            </a>
      ...
      <section className="bg-gradient-to-r from-slate-950 via-slate-900 to-blue-950 border-b border-slate-800 py-12 sm:py-16 px-4 shadow-2xl relative overflow-hidden w-full">
        <div className="max-w-5xl mx-auto text-center space-y-6">
          ...
          <div className="flex flex-wrap items-center justify-center gap-4 pt-2">
            <a 
              href="/auth" 
              className="px-8 py-3.5 bg-gradient-to-r from-cyan-600 to-blue-600 hover:from-cyan-500 text-white font-extrabold text-xs sm:text-sm rounded-2xl transition shadow-xl shadow-cyan-600/25 flex items-center gap-2"
            >
      ...
      <div className="max-w-7xl mx-auto px-4 pt-8 space-y-12 w-full">
        ...
        <section id="how-it-works" className="space-y-6 scroll-mt-24">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="bg-slate-950 border border-slate-800 rounded-3xl p-6 space-y-3 relative hover:border-cyan-800/60 transition">
              ...
              <h3 className="font-bold text-white text-base">Offer Your Skills</h3>
              <p className="text-xs text-slate-400 leading-relaxed">
                Share what you are good at—fix a bicycle, teach guitar, garden, or care for elderly neighbors. 1 hour of labor earns 60 Time Minutes.
              </p>
            </div>
            ...
            <div className="bg-slate-950 border border-slate-800 rounded-3xl p-6 space-y-3 relative hover:border-emerald-800/60 transition">
              ...
              <h3 className="font-bold text-white text-base">Safe Holding & 4-Digit PIN</h3>
              <p className="text-xs text-slate-400 leading-relaxed">
            ...
            <div className="bg-slate-950 border border-slate-800 rounded-3xl p-6 space-y-3 relative hover:border-amber-800/60 transition">
              ...
              <h3 className="font-bold text-white text-base">Redeem Meals or Skills</h3>
              <p className="text-xs text-slate-400 leading-relaxed">
        ...
        <section className="bg-gradient-to-r from-cyan-950 via-slate-900 to-blue-950 border border-cyan-800/60 rounded-3xl p-6 sm:p-8 flex flex-col sm:flex-row items-center justify-between gap-6 shadow-2xl">
          <div className="space-y-2 text-center sm:text-left">
            <span className="text-xs font-bold text-cyan-400 uppercase tracking-wider">No Cash Needed</span>
            <h3 className="text-xl sm:text-2xl font-extrabold text-white">Ready to exchange skills with neighbors?</h3>
            <p className="text-xs text-slate-300">Join over 1,000+ local community members trading labor and food credits today.</p>
          </div>
          <a
            href="/auth"
