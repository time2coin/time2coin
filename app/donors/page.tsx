...
import { 
  ...
  Users, HandCoins, Shield, LogIn, DollarSign, ArrowLeft
} from 'lucide-react';
        ...
        <div className="max-w-7xl mx-auto flex items-center justify-between gap-2">
          <div className="flex items-center gap-3">
            ...
            <a href="/" className="flex items-center gap-2">
              ...
              <span className="font-bold text-lg text-white">time2coin <span className="text-rose-400 text-xs font-normal hidden sm:inline">| Private Donors Portal</span></span>
            </a>
          </div>
